...
export default class AccFromComp extends Component{
  constructor(props){
    super(props);
    this.state = {}
  }
        ...
        <div style={{float:'left'}}>
          <SideMenuComp/>
  			...
  			<div className="sta-content">
  				...
  				<h5 className="syz-title">调 帐 报 表</h5>
  				<div className="chukubaobiao">
  					...
  					<div className="baobiao-right">
  						<div className="zyx-label">
  							<input type="checkbox" id="zyx-label" class="syz_input"/>
  							<label for="zyx-label" className='syz_label'>调账时间</label>
  						</div>
